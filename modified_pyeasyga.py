...
class GeneticAlgorithm(object):
    ...
    def create_new_population(self):
        ...
        while len(new_population) < self.population_size:
            ...
            children = []
            if can_mutate:
                new_child11 = copy.deepcopy(child_1)
    ...
    def run(self):
        ...
        try:
          while self.best_individual()[0] < 162:
            '''
            if self.best_individual()[0] == 150:
              print(self.best_individual()[1])
            '''
            self.n_iterations += 1
            self.create_next_generation()
        except KeyboardInterrupt:
          print(self.best_individual()[0])
